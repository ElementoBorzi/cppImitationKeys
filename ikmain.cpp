...
int main()
{
    DWORD processId = 1488; // Замените 1488 на фактический ID процесса, в который вы хотите отправлять цифры
    ...
    if (hwnd == NULL)
    {
        std::cout << "Ошибка: не удалось найти окно процесса с ID " << processId << std::endl;
        return 1;
    }
